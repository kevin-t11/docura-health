...
/** Animate badge content and status changes with reduced-motion support. */
...
type AnimatedBadgeStatus = 'neutral' | 'info' | 'success' | 'warning' | 'danger' | 'loading';

type AnimatedBadgeSize = 'sm' | 'md';
...
const STATUS_CLASS: Record<AnimatedBadgeStatus, string> = {
  ...
  success: 'border-primary/20 bg-soft text-primary',
  warning: 'border-amber-500/30 bg-amber-500/10 text-amber-600 dark:text-amber-400',
  danger: 'border-destructive/30 bg-destructive/10 text-destructive',
  loading: 'border-primary/20 bg-soft text-primary'
};
...
const ICONS: Record<AnimatedBadgeStatus, AppIcon> = {
  neutral: Circle,
  info: Info,
  success: Check,
